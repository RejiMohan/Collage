/*
 * UpdateImagePool.java
 *
 * Created on January 1, 2011, 6:38 PM
 */
...
// TODO add your handling code here:
    try 
    {
        ...
        for(i=0;i<v.size();i++)
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "ImagePool Updation of "+dp.getUser(v.elementAt(i).toString())+" not successful");
                if(!(users.contains(v.elementAt(i))))
                {
...
// TODO add your handling code here:
    try 
    {
        ...
        for(int i=0;i<users.size();i++)
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "ImagePool updation of "+dp.getUser(users.elementAt(i).toString())+" not successful");
