...
public class MessageOut extends javax.swing.JFrame {
    ...
    public MessageOut() {
        ...
        try
        {
            ...
            mess_txt.setText(new ImageFinder().getMess("./sent/"+new Login().u+"/"+new Sent().r_name+".jpg"));
            //System.out.println("./sent/"+new Login().u+"/"+new Sent().r_name+".jpg");
        }
        catch (Exception e)
        {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(receiver, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
...
// TODO add your handling code here:
    File f=new File("./sent/"+new Login().u+"/"+new Sent().r_name+".jpg");
    f.delete();
